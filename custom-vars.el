...
(custom-set-variables
  ...
  '(package-selected-packages
     '(ace-window apheleia beacon cape claude-code-ide consult-eglot
        consult-yasnippet corfu denote diff-hl diminish dired-preview
        dired-subtree diredfl dirvish doom-modeline dumb-jump eat
        editorconfig elisp-demos embark-consult eros expreg git-modes
        go-mode goto-chg grip-mode helpful jinx json-mode kind-icon
        magit marginalia markdown-toc modus-themes multiple-cursors
        nerd-icons-completion nerd-icons-dired nix-mode olivetti
        orderless org-roam package-lint-flymake puni ready-player
        shut-up slack spacious-padding suggest tempel treesit-auto
        undo-fu undo-fu-session use-package vertico-prescient
