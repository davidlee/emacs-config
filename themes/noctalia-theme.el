...
(let* ((bg "#1a1b26")
      (err "#f7768e")
      (err-container "#bb0023")
      (on-background "#c0caf5")
      (on-err "#16161e")
      (on-err-container "#fccfd7")
      (on-primary "#16161e")
      (on-primary-container "#cfddfc")
      (on-secondary "#16161e")
      (on-secondary-container "#dfd0fb")
      (on-surface "#c0caf5")
      (on-surface-variant "#9aa5ce")
      (on-tertiary "#16161e")
      (on-tertiary-container "#e6f2d9")
      (outline-color "#5d6682")
      (outline-variant "#3d4355")
      (primary "#7aa2f7")
      (primary-container "#003dbf")
      (secondary "#bb9af7")
      (secondary-container "#4f00df")
      (shadow "#15161e")
      (surface "#1a1b26")
      (surface-container "#24283b")
      (surface-container-high "#2c3148")
      (surface-container-highest "#333954")
      (surface-container-low "#1f2130")
      (surface-container-lowest "#1c1d2a")
      (surface-variant "#24283b")
      (tertiary "#9ece6a")
      (tertiary-container "#446e17")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9ece6a")
      (on-success "#16161e")
      (success-container "#446e17")
      (on-success-container "#e6f2d9")
      ;; Map fixed colors to regular colors
      (primary-fixed "#7aa2f7")
      (primary-fixed-dim "#003dbf")
      (secondary-fixed "#bb9af7")
      (secondary-fixed-dim "#4f00df")
      (tertiary-fixed "#9ece6a")
      (tertiary-fixed-dim "#446e17")
      (on-primary-fixed "#16161e")
      (on-primary-fixed-variant "#cfddfc")
      (on-secondary-fixed "#16161e")
      (on-secondary-fixed-variant "#dfd0fb")
      (on-tertiary-fixed "#16161e")
      (on-tertiary-fixed-variant "#e6f2d9")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#c0caf5")
      (inverse-primary "#7aa2f7")
      (inverse-surface "#1a1b26")
