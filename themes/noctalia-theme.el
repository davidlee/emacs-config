...
(let* ((bg "#282828")
      (err "#fb4934")
      (err-container "#7a0f02")
      (on-background "#fbf1c7")
      (on-err "#282828")
      (on-err-container "#fed2cd")
      (on-primary "#282828")
      (on-primary-container "#f6f6d5")
      (on-secondary "#282828")
      (on-secondary-container "#feefcd")
      (on-surface "#fbf1c7")
      (on-surface-variant "#ebdbb2")
      (on-tertiary "#282828")
      (on-tertiary-container "#e1eae6")
      (outline-color "#76706c")
      (outline-variant "#4e4a47")
      (primary "#b8bb26")
      (primary-container "#40420b")
      (secondary "#fabd2f")
      (secondary-container "#745202")
      (shadow "#282828")
      (surface "#282828")
      (surface-container "#3c3836")
      (surface-container-high "#474240")
      (surface-container-highest "#514c49")
      (surface-container-low "#32302f")
      (surface-container-lowest "#2c2b2a")
      (surface-variant "#3c3836")
      (tertiary "#83a598")
      (tertiary-container "#2a4b3f")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#83a598")
      (on-success "#282828")
      (success-container "#2a4b3f")
      (on-success-container "#e1eae6")
      ;; Map fixed colors to regular colors
      (primary-fixed "#b8bb26")
      (primary-fixed-dim "#40420b")
      (secondary-fixed "#fabd2f")
      (secondary-fixed-dim "#745202")
      (tertiary-fixed "#83a598")
      (tertiary-fixed-dim "#2a4b3f")
      (on-primary-fixed "#282828")
      (on-primary-fixed-variant "#f6f6d5")
      (on-secondary-fixed "#282828")
      (on-secondary-fixed-variant "#feefcd")
      (on-tertiary-fixed "#282828")
      (on-tertiary-fixed-variant "#e1eae6")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#fbf1c7")
      (inverse-primary "#b8bb26")
      (inverse-surface "#282828")
