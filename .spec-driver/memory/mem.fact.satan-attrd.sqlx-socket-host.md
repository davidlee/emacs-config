---
id: mem.fact.satan-attrd.sqlx-socket-host
name: sqlx ignores libpq socket host param
kind: memory
status: active
memory_type: fact
created: '2026-05-30'
...
scope:
  globs:
    - 'tests/common/mod.rs'
    - 'tests/**'
summary: PgConnectOptions::from_str drops the ?host= socket query param; works on
  Sleipnir only via /var/run->/run symlink
---
