---
id: mem.fact.satan.jailed-agent-loopback
slug: satan_jailed_agent_loopback_reachability
name: SATAN jailed agent loopback reachability
kind: memory
status: active
memory_type: fact
created: '2026-05-31'
...
- jail
- networking
summary: Current specDev jailed-agent bwrap profile shares host loopback; generated
  agent wrappers are not general diagnostic shells.
---
