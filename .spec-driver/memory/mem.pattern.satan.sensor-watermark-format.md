---
id: mem.pattern.satan.sensor-watermark-format
name: SATAN sensor watermark must match the source timestamp format
kind: memory
status: active
memory_type: pattern
created: '2026-06-03'
...
- sensor
- content
summary: Content-store captured_at is UTC-millis-Z; curiosity's mark-inspected formats
  local-offset. A sensor watermark compared with string< MUST store the source timestamp
  verbatim, never a formatted now().
---
