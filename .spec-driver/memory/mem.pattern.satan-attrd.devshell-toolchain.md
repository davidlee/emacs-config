---
id: mem.pattern.satan-attrd.devshell-toolchain
name: satan-attrd cargo tooling via flake devshell
kind: memory
status: active
memory_type: pattern
created: '2026-05-30'
...
- toolchain
- direnv
summary: system cargo lacks fmt/clippy; run satan-attrd cargo commands through the
  flake devshell (direnv exec), which also sets the prod-socket DATABASE_URL
---
