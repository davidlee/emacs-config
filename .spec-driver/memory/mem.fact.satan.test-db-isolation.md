---
id: mem.fact.satan.test-db-isolation
name: SATAN test DB isolation + skip-unless
kind: memory
status: active
memory_type: fact
created: '2026-05-30'
...
- satan
- testing
summary: "DB-backed SATAN tests isolate to dedicated test DBs and skip-unless reachable;\
  \ pure suites mock psql. just check runs ALL suites \u2014 do not re-add a subsystem\
  \ exclusion."
---
