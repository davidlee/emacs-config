---
id: mem.fact.satan.git-sensor-bwrap-blind
name: SATAN git sensor is bwrap-blind to jailed-agent commits
kind: memory
status: active
memory_type: fact
created: "2026-06-05"
...
verified: "2026-06-05"
confidence: high
tags: [satan, sensor, git, jail, panopticon]
scope:
  paths:
    - satan/bin/satan-git-post-commit
    - satan/dl-satan-memory-evidence.el
provenance:
  sources:
    - satan/bin/satan-git-post-commit
    - satan/dl-satan-memory-evidence.el
    - ~/dev/panopticon/README.md
    - POL-001
summary: "The git-activity feed undercounts because the post-commit hook depends on host core.hooksPath, which bwrap-jailed agents (clanker) don't carry; their commits never produce a segment row."
---
